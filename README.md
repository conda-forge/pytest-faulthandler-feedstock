About pytest-faulthandler-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-faulthandler-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=934&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-faulthandler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-faulthandler` can be installed with `conda`:
...
```
mamba install pytest-faulthandler
```

It is possible to list all of the versions of `pytest-faulthandler` available on your platform with `conda`:
...
```
mamba search pytest-faulthandler --channel conda-forge
```
...
mamba repoquery search pytest-faulthandler --channel conda-forge

# List packages depending on `pytest-faulthandler`:
mamba repoquery whoneeds pytest-faulthandler --channel conda-forge

# List dependencies of `pytest-faulthandler`:
mamba repoquery depends pytest-faulthandler --channel conda-forge
```
